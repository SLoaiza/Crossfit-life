<nav class="z-depth-2 m12 s12 menu" >
	<div class="nav-wrapper  z-depth-1" color:"#424242">
		...
		<ul class="hide-on-med-and-down">
			<li><a href="instructor.php?S=<?php echo base64_encode("perfil");?>" class="whithe-text">Inicio</a></li>
			<li><a href="instructor.php?S=<?php echo base64_encode("actividad");?>" class="whithe-text">Gestionar actividades</a></li>
      <li><a href="instructor.php?S=<?php echo base64_encode("rutina");?>" class="whithe-text">Gestionar rutinas</a></li>
			<li><a href="instructor.php?S=<?php echo base64_encode("valoraciones");?>" class="whithe-text">Ver valoraciones</a></li>
